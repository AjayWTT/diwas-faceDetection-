...
from config import (ALLOWED_EXTENSIONS, FOLDER_NAME, HAARCASCADE_FRONTALFACE_XML, HAARCASCADE_EYE_XML,
...
def detect_faces(image_path):
    ...
    eye_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + HAARCASCADE_EYE_XML)
    ...
    for (x, y, w, h) in faces:
        ...
        if len(eyes) >= 2:  # Assuming at least two eyes detected
