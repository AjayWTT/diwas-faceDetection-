...
def compare_faces(face1_path, face2_path, threshold=30.0, model_name=MODEL_NAME_FOR_COMPARE_FACES, distance_metric=DISTANCE_METRIC_FOR_COMPARE_FACES):
    try:
        result = DeepFace.verify(img1_path=face1_path, img2_path=face2_path, model_name=model_name, distance_metric='euclidean', align=True, detector_backend='mtcnn')
